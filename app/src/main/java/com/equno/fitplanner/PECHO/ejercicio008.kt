...
class ejercicio008 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio008)
        ...
        val imageView: ImageView =findViewById(R.id.pressinclinadopecho)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/SqT0lZDPm-Y"))
            startActivity(intent)
        }
    }
}