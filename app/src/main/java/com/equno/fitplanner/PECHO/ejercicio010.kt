...
class ejercicio010 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio010)
        ...
        val imageView: ImageView =findViewById(R.id.fondospecho)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/lC7lLkjDZ_k"))
            startActivity(intent)
        }
    }
}