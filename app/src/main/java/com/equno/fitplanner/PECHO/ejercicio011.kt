...
class ejercicio011 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio011)
        ...
        val imageView: ImageView =findViewById(R.id.crossoverpecho)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/nP9KArjEDeU"))
            startActivity(intent)
        }
    }
}