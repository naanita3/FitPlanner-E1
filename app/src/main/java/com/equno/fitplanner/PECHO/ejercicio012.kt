...
class ejercicio012 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio012)
        ...
        val imageView: ImageView =findViewById(R.id.flexiones)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/YXI_V2sIO_Y"))
            startActivity(intent)
        }
    }
}