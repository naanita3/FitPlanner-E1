...
class ejercicio015 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio015)
        ...
        val imageView: ImageView =findViewById(R.id.swingpesasrusas)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/P-dbz0nxupg"))
            startActivity(intent)
        }
    }
}