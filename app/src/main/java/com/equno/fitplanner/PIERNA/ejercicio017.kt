...
class ejercicio017 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio017)
        ...
        val imageView: ImageView =findViewById(R.id.quadextension)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/FtXooCm3wdQ"))
            startActivity(intent)
        }
    }
}