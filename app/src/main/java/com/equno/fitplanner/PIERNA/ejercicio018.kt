...
class ejercicio018 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio018)
        ...
        val imageView: ImageView =findViewById(R.id.frontalsquat)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/nOilmCM2TPI"))
            startActivity(intent)
        }
    }
}