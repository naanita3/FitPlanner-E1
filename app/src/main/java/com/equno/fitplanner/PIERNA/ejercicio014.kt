...
class ejercicio014 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio014)
        ...
        val imageView: ImageView =findViewById(R.id.curltumbado)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/i5Kvc8ie6EI"))
            startActivity(intent)
        }
    }
}