...
class ejercicio016 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio016)
        ...
        val imageView: ImageView =findViewById(R.id.pesomuertorumano)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/V0SfMaC_t6c"))
            startActivity(intent)
        }
    }
}