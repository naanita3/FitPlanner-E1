package com.equno.fitplanner.ESPALDA
...
class ejercicio006 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio006)
        ...
        val imageView: ImageView =findViewById(R.id.remogironda)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/GMrTWQ2kmcs"))
            startActivity(intent)
        }
    }
}