...
class ejercicio005 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio005)
        ...
        val imageView: ImageView =findViewById(R.id.pullups)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/6E3tt4ajzSs"))
            startActivity(intent)
        }
    }
}