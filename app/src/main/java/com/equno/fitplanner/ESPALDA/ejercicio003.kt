...
class ejercicio003 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageView: ImageView =findViewById(R.id.remomancuerna)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/YBBRf8iIkZU"))
            startActivity(intent)
        }
    }
}