...
class ejercicio004 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio004)
        ...
        val imageView: ImageView =findViewById(R.id.pullover)
        imageView.setOnClickListener {
            val intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/BM9arxNbrLg"))
            startActivity(intent)
        }
    }
}