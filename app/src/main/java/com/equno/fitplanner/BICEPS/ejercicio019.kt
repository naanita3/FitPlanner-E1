...
class ejercicio019 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_ejercicio019)
        ...
        val imageView: ImageView =findViewById(R.id.bicepsmancsupino)
        imageView.setOnClickListener{
            val intent= Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/shorts/LQcQNJiVY24"))
            startActivity(intent)
        }
    }
}